function getHeader() {
    return {'Authorization': 'Bearer ' + "10728|hLidBRSDAUOmOppvVuLX4pRqVwomcDz9usO92wRLbQbPgLeWClkFyipvYLydhwbxF6I5i3nmkVgR/K8SEd11eg=="}
}
function Toast(tip,timeout) {
    timeout = timeout || 2000;
    var oBody = document.getElementsByTagName('body')[0];
    var oStyle = document.createElement('style');
    oStyle.innerHTML = '.toast{z-index:10000000000;animation: toast 1s linear; -webkit-animation: toast 1s linear; max-width: 3rem;padding: .16rem .27rem;border-radius: .07rem;background: rgba(0,0,0,.7);color: #fff;position: fixed;text-align: center;top:50%;left: 50%;transform: translate3d(-50%,-50%,0); -webkit-transform: translate3d(-50%,-50%,0); }\n' +
