<template>
  <div v-loading.fullscreen.lock="fullscreenLoading"
    ...
    <div class="logo"></div>
    <div :class="$i18n.locale" class="title f22"></div>
    <ul class="product-list">
      <li :class="{'current-router': currentRouter === '/currentTask' || currentRouter === '/'}" @click="handleSwitch('/currentTask')"><i class="iconfont icon-shishirenwu-"></i><span>{{ $t('vHeader.currentTask') }}</span></li>
      <li :class="{'current-router': currentRouter !== '/currentTask' && currentRouter !== '/'}" @click="handleSwitch('/systemSetting')"><i class="iconfont icon-xitongshezhi-"></i><span>{{ $t('vHeader.systemSetting') }}</span></li>
    </ul>
