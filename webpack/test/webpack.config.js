...
module.exports = {
    ...
    plugins: [
        // new webpack.HotModuleReplacementPlugin(), //和package里面的-hot有所冲突
        ...
        //     comments: false, // remove all comments //去掉注释
        //     compress: {
        //         warnings: false   //忽略警告
        //     }
        // }),
        // new ExtractTextPlugin({filename: '[name].[hash:8].css', allChunks: false}),
    ],
    resolve: {
        alias: {
