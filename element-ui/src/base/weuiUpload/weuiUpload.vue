      ...
      <div class="weui-uploader">
        ...
        <div class="weui-uploader__bd">
          <ul class="weui-uploader__files weui-uploader-box" ref="ul" @click="show">
            <template v-for="img in initList">
              <li class="weui-uploader__file" :style='background(typeof img==="string"?img:img.file_url)'></li>
            </template>
          </ul>
...
<script>
  ...
  export default {
    props: {
      ...
      maxLimit:{type:Number,default:5},    //限制最大上传张数，默认为5张
      onceLimit:{type:Number,default:3},      //限制一次性上传的张数，默认为3张
    },
    data() {
      return {
        initList: [],
