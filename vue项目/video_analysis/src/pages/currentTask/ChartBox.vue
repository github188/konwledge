  ...
  <div class="chart-layer">
    ...
    <div class="list-layer">
      <div class="info">
        <ul>
          <li class="xingren">
            <i class="iconfont icon-hangren"></i><span>行人</span>
            <div>{{ carDataFilter[0].count }}</div>
          </li>
          <li class="jiaoche">
            <i class="iconfont icon-jiaoche"></i><span>轿车</span>
            <div>{{ carDataFilter[2].count }}</div>
          </li>
          <li class="mianbaoche">
            <i class="iconfont icon-mianbaoche"></i><span>面包车</span>
            <div>{{ carDataFilter[6].count }}</div>
          </li>
          <li class="kache">
            <i class="iconfont icon-qiache"></i><span>卡车</span>
            <div>{{ carDataFilter[7].count }}</div>
          </li>
          <li class="dakeche">
            <i class="iconfont icon-dakeche"></i><span>大客车</span>
            <div>{{ carDataFilter[4].count }}</div>
          </li>
          <li class="motuoche">
            <i class="iconfont icon-motuoche"></i><span>摩托车</span>
            <div>{{ carDataFilter[3].count }}</div>
          </li>
          <li class="sanlunche">
            <i class="iconfont icon-sanlunche"></i><span>三轮车</span>
            <div>{{ carDataFilter[5].count }}</div>
          </li>
          <li class="zixingche">
            <i class="iconfont icon-zihangche"></i><span>自行车</span>
  ...
  export default {
      ...
      carDataFilter () {
        if (this.carData.length === 0) {
          return [
            ...
            {"code": "3", "type": "轿车", "count": "0", "sort": "2"},
            {"code": "4", "type": "摩托车", "count": "0", "sort": "1"},
            {"code": "5", "type": "大客车", "count": "0"},
            {"code": "6", "type": "三轮车", "count": "0", "sort": "4"},
    ...
    methods: {
      ...
      ininChart() {
          ...
          xAxis: [
            {
              type: 'category',
              data: [
                {value: '行人', textStyle: {fontSize: 16, color: '#29b2fa'}},
                {value: '轿车', textStyle: {fontSize: 16, color: '#29b2fa'}},
                {value: '面包车', textStyle: {fontSize: 16, color: '#29b2fa'}},
                {value: '卡车', textStyle: {fontSize: 16, color: '#29b2fa'}},
                {value: '大客车', textStyle: {fontSize: 16, color: '#29b2fa'}},
                {value: '摩托车', textStyle: {fontSize: 16, color: '#29b2fa'}},
                {value: '三轮车', textStyle: {fontSize: 16, color: '#29b2fa'}},
                {value: '自行车', textStyle: {fontSize: 16, color: '#29b2fa'}}
              ],
              axisTick: {
                alignWithLabel: true,
                interval: 0,
        ...
        myChart = echarts.init(this.$refs.chartBar)
        ...
        option.xAxis = [
          {
            type: 'category',
            data: [
              {value: '行人', textStyle: {fontSize: 16, color: showColor(statistic[0].sort)}},
              {value: '轿车', textStyle: {fontSize: 16, color: showColor(statistic[3].sort)}},
              {value: '面包车', textStyle: {fontSize: 16, color: showColor(statistic[6].sort)}},
              {value: '卡车', textStyle: {fontSize: 16, color: showColor(statistic[7].sort)}},
              {value: '大客车', textStyle: {fontSize: 16, color: showColor(statistic[5].sort)}},
              {value: '摩托车', textStyle: {fontSize: 16, color: showColor(statistic[2].sort)}},
              {value: '三轮车', textStyle: {fontSize: 16, color: showColor(statistic[4].sort)}},
              {value: '自行车', textStyle: {fontSize: 16, color: showColor(statistic[1].sort)}}
            ],
            axisTick: {
              alignWithLabel: true,
              interval: 0,
