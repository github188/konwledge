<template>
  <fill-content ref="fillContent" title="设备操作" class-name="device-page" close-bg>
    <div class="d-box fl reset-procedure">
      <div class="tips"><span class="f14" @click="resetSoftware">重启程序</span></div>
    </div>
    <div class="d-box fl reset-device">
      <div class="tips"><span class="f14" @click="rebootDev">重启设备</span></div>
    </div>
    <div class="d-box fl reset-system">
      <div class="tips"><span class="f14" @click="initAll">恢复出厂设置</span></div>
    </div>
