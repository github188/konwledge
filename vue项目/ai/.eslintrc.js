module.exports = {
    ...
    rules: {
        ...
        'no-console': process.env.NODE_ENV === 'production' ? 'error' : 'off', //不允许出现console语句
        ...
        'dot-notation': ['off', {'allowKeywords': false, 'allowPattern': ''}], //获取对象属性的时候使用点号
        ...
        'no-eq-null': 2, //不允许对null用==或者!=,请先转换类型再使用===或!==
        'no-eval': 2, //不允许使用eval()
        ...
        'consistent-this': [2, '_this'], //当获取当前环境的this是用一样的风格
        'eol-last': 2, //文件以换行符结束
