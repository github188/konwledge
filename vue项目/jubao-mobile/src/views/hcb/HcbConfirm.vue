  ...
  <div class="hcbConfirm">
    ...
    <div class="content_box">
      ...
      <div class="confirm_bottom">
        ...
        <div class="next">
          <router-link :to="{path:'/hcbCreate',query:{orderId:orderId}}" v-touchFeel="{color:'#f2f2f2'}">返回并修改</router-link>
          <router-link :to="{path:'/policyDown',query:{orderId:orderId,product:'hcb'}}" v-touchFeel="{color:'#0fbcf7'}" class="blue_bg">下一步</router-link>
        </div>
      </div>
    </div>
  </div>
