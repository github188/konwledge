<template>
  <div class="spb">
    <v-header title="冷链保"></v-header>
    <div class="content_box">
      <div class="content">
        <div class="all">
          <div class="banner">
            <img v-lazy="require('../../assets/img/llb/llbBanner.png')" alt="">
          </div>
          <div class="pro_video">
            <div class="video-wrapper">
              ...
              <div class="poster" v-lazy:background-image="poster" v-show="isVideoEnd">
                ...
                <div class="tip">为什么要选择聚保冷链保</div>
              </div>
            </div>
          </div>
          <ul class="zcb_count">
            <li class="title">冷链保----公路货运基本险</li>
          ...
          <div class="pro_info" v-show="tabIndex===2">
            ...
            <div class="pro_item pro_item2">
              ...
              <div class="item_text">
                <p>冷冻品（如肉类等）、冷藏货物（如水果类等）、恒温运输货物等。</p>
              </div>
            </div>
            ...
            <div class="pro_item pro_item2">
              ...
              <div class="item_text">
                <p>每次事故绝对免赔额：RMB2000元或损失金额的15%，两者以高者为准。</p>
              </div>
            </div>
            <div class="pro_item pro_item2">
              <div class="item_title">
            ...
            <div class="pro_item pro_item9">
              ...
              <div class="item_text">
                <p>无需签订预约协议，单票货物可随时投保，赢得货主的信任。</p>
                <p>
                  本保险单次限额高达200万，满足高端高价值冷链保障需求。
                </p>
              </div>
            </div>
      ...
      <div class="pro_foot">
        ...
        <router-link to="/llbCreate" class="button bg-blue">立即投保</router-link>
      </div>
    </div>
  </div>
</template>
...
<script>
  ...
  let spbImgList = [];
  for (let i=0;i<5;i++){
    spbImgList[i+1] = require('../../assets/img/llb/llb'+(i+1)+'.png')
  }
  export default {
    mixins:[dchybDetail],
    data() {
...
<style lang="scss" scoped>
  ...
  ul.zcb_count{
    ...
    li.distance_price_count{
      ...
      //select.zcb_select1{
      //  width:pxToRem(170);height:pxToRem(50);position: relative;
      //}
      //select.zcb_select2{
      //  width:pxToRem(220);height:pxToRem(50);
      //}
    }
    li{
