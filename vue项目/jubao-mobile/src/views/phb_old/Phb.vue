<template>
  <div class="spb">
    <v-header title="普货保"></v-header>
    <div class="content_box">
      <div class="content">
        <div class="all">
          <div class="banner">
            <img v-lazy="require('../../assets/img/phb/phbBanner.png')" alt="">
          </div>
          <div class="pro_video">
      ...
      <div class="pro_foot">
        ...
        <router-link to="/phbCreate" class="button bg-blue">立即投保</router-link>
      </div>
    </div>
  </div>
</template>
...
<script>
  ...
  let spbImgList = [];
  for (let i=0;i<7;i++){
    spbImgList[i+1] = require('../../assets/img/phb/phb'+(i+1)+'.png')
  }
  export default {
    mixins:[dchybDetail],
    data() {
